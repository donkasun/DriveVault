/**
 * Modal bottom sheet for the vehicle filter. Parity with Flutter activity
 * screen's `_ActivityFilterSheet` / `_VehicleFilterRow`.
 */
...
export function VehicleFilterSheet({ visible, vehicles, selectedVehicleId, onSelect, onClose }: Props) {
  const rows: Row[] = [
