...
from sqlalchemy import BigInteger, Column, Date, ForeignKey, Index, Integer, Text, TIMESTAMP, func
...
class MaintenanceRecord(Base):
    ...
    ai_extraction_id: Mapped[UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
